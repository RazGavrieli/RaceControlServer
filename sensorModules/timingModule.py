...
if __name__=="__main__":
    ...
    connection = pika.BlockingConnection(pika.ConnectionParameters(host='rabbitmq', socket_timeout=None))
    ...
    while True:
        try:
            ...
            time.sleep(2.5)
            connection = pika.BlockingConnection(pika.ConnectionParameters('rabbitmq', socket_timeout=None))
            channel = connection.channel()
            channel.queue_declare(queue='TIMING')
